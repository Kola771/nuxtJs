...
function createValidationPlugin(baseRules = {}) {
  return function validationPlugin(node) {
    ...
    function reboot(newValidation, newRules) {
      ...
      (_a = node.props.parsedRules) == null ? void 0 : _a.forEach((validation210) => {
        removeMessage(validation210);
...
function removeMessage(validation47) {
...
function createI18nPlugin(registry) {
  return function i18nPlugin(node) {
    ...
    node.hook.text((fragment, next) => {
      var _a, _b;
      const key = ((_a = fragment.meta) == null ? void 0 : _a.messageKey) || fragment.key;
      if (has(locale, fragment.type) && has(locale[fragment.type], key)) {
        const t = locale[fragment.type][key];
        if (typeof t === "function") {
          fragment.value = Array.isArray((_b = fragment.meta) == null ? void 0 : _b.i18nArgs) ? t(...fragment.meta.i18nArgs) : t(fragment);
        } else {
          fragment.value = t;
        }
      }
...
//# sourceMappingURL=chunk-IOWBES6Y.js.map
